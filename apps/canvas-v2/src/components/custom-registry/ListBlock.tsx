...
/**
 * 1. ListBlock - এখন বিভিন্ন layout support করে!
 */
export const ListBlockComponent: React.FC<{
  ...
  const gap = spacingValues[spacing as keyof typeof spacingValues] || "0.5rem";
  ...
  // ✅ NUMBERED LAYOUT - Content same, শুধু numbering add!
  if (layout === "numbered") {
    return (
      <ol
...
export const ListBlockDef: CustomComponentDef = {
  name: "Simple List",
