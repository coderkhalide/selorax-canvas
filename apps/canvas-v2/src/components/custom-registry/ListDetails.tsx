 ...
 */
export const ListWithDetailsComponent: React.FC<{
  ...
  return (
    <div style={element.style} className={`w-full space-y-4 ${element.className || ""}`}>
...
export const ListWithDetailsDef: CustomComponentDef = {
  name: "Detail List",
