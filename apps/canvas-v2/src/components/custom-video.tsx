...
export const VideoCardComponent: React.FC<{
...
const getYouTubeIdAndList = (url: string): { id?: string; list?: string } => {
  try {
    const u = new URL(url);
...
export const VideoCardDef: CustomComponentDef = {
  name: "Video Cards",
  icon: React.createElement("span", { className: "w-4 h-4" }, "🎞️"),
  category: "Media",
