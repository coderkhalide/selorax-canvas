...
const resolveLabel = (item) => item?.name || item?.title || "Collection";
...
const CustomCategoryComponent = ({
  ...
  const dataCategories = propCategories || categories;
  const list = useMemo(
    () => (dataCategories || []).filter(Boolean),
    [dataCategories]
  );
  ...
  if (layout === "shop_by_category") {
    ...
    return (
      <section
        ...
        style={{ ...element.style, background: sectionBg }}
    ...
    return (
      ...
      >
        ...
        <div className="mt-10 relative">
          ...
          {(sliderShowArrows || sliderShowDots) && (
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              style={{ borderColor: canPrev ? activeColor : "transparent" }}
            >
              <span
            ...
            <button
              ...
              style={{ borderColor: canNext ? activeColor : "transparent" }}
            >
              <span
                className="h-2 w-2 rounded-full"
                style={{
  ...
  if (layout === "split") {
    return (
      <div
        className="px-4 py-6 sm:px-6 lg:px-8 md:pt-16"
        style={{ ...element.style }}
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
      >
                  ...
                  return (
                    ...
                    >
                      ...
                      <p
                        ...
                        style={{ color: labelColor, fontSize: "1rem" }}
                      >
                        {label}
                      </p>
                    </a>
...
export const CustomCategoryDef = {
  ...
  settings: {
    ...
    heading: { type: "text", label: "Heading", default: "Featured Categories" },
    description: {
      type: "text",
    ...
    headingColor: { type: "color", label: "Heading Color", default: "#1D2B3A" },
    descriptionColor: {
      type: "color",
